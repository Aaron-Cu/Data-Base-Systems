...
/* What are the names, gender, and altered status of the pets in the database? */
...
/* What is the highest test score for each test? */ 
...
/* What is the total nuber of scores for each student who has taken exactly three test (ie has 3 scores)? */
...
/* What is the total number of scores for each test that has been taken by 3 students (ie has 3 scores)? */

SELECT TestID, COUNT(Scores)
FROM TEST_SCORES
GROUP BY TestID
HAVING COUNT(Score) = 3;
...
/* What is the lowest score fore each test with exactly three scores (ie taken by 3 students)? */
...
/* What are the genders of all the different pets in the database? */
...
/* What are the distinct genders and aletered status of the pets in the database? */
